...
<div class="content">
  <div class="content__info">
    ...
    <div class="content__image">
      <img alt="Here I am" src="profile.jpeg" />
    </div>
  ...
  <h2>👨‍🔧About Me</h2>
  <p>Welcome to my personal website!👋 I'm Aaro Alhainen, a passionate and versatile Software Developer and Web Browser Engineer based in Helsinki, Finland. I have been working in the software industry since 2017 and currently I'm employed by a company that offers a world leading Sales Acceleration Platform. In my spare time, I'm also developing my own web browser project, tentatively named <a href="https://github.com/aaralh/theBrowser">theBrowser</a> (I'm still working on a better name😅).</p>
  <br/>
  <h2>🛠️My Skills</h2>
